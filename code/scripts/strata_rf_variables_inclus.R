...
strata_states_rf_3_inclus <- strata_glm_pp(
  dat = data_to_use,
...
strata_states_rf_nonyc_3_inclus <- strata_glm_pp(
  dat = data_to_use,
  date_ts = date_tostudy,
  form_ps = form_ps,
  form_glm = form_state,
...
strata_divname_rf_3_inclus <- strata_glm_pp(
  dat = data_to_use,
  date_ts = date_tostudy,
  filt_c = 1,
  form_ps = form_ps,
...
strata_divname_rf_nonyc_3_inclus <- strata_glm_pp(
  dat = data_to_use,
  date_ts = date_tostudy,
  filt_c = 1,
  form_ps = form_ps,
...
strata_noadj_rf_3_inclus <- strata_glm_pp(
  dat = data_to_use,
  date_ts = date_tostudy,
  form_ps = form_ps,
  form_glm = form_x,
...
strata_weights_MRR(strata_noadj_rf_3_inclus)

# @@@@@@@@@@@@@@
# Calculate MRR-
# @@@@@@@@@@@@@@

strata_rf_results_3_inclus <- bind_rows(
  strata_states_rf_3_inclus,
  strata_states_rf_nonyc_3_inclus,
  strata_divname_rf_3_inclus,
  strata_divname_rf_nonyc_3_inclus
)

strata_rf_results_splitted_3_inclus <- strata_rf_results_3_inclus %>%
  unite("date_filt_analysis", c("date", "filt_cases_c", "analysis")) %>%
  select(-model, -data) %>%
  split.data.frame(., .$date_filt_analysis)


MRR_strata_rf_3_inclus <- map_dfr(strata_rf_results_splitted_3_inclus, strata_weights_MRR) %>%
...
MRR_strata_rf_3_today_inclus <- MRR_strata_rf_3_inclus %>%
