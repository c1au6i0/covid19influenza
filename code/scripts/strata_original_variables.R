...
strata_states_original_dates_3 <- map_dfr(dates_tostudy, strata_glm_pp,
  dat = data_to_use,
  filt_c = 1,
  form_ps = form_ps,
  form_glm = form_state,
...
strata_states_original_cases_3 <- map_dfr(to_filt_cases, strata_glm_pp,
  dat = data_to_use,
...
strata_states_original_nonyc_3 <- strata_glm_pp(
  dat = data_to_use,
  date_ts = max(dates_tostudy),
  form_ps = form_ps,
  form_glm = form_state,
...
strata_divname_original_dates_3 <- map_dfr(dates_tostudy, strata_glm_pp,
  dat = data_to_use,
  filt_c = 1,
  form_ps = form_ps,
...
strata_divname_original_cases_3 <- map_dfr(to_filt_cases, strata_glm_pp,
  dat = data_to_use,
  date_ts = max(dates_tostudy),
  form_ps = form_ps,
  form_glm = form_divname,
...
strata_divname_original_nonyc_3 <- strata_glm_pp(
  dat = data_to_use,
  date_ts = max(dates_tostudy),
  form_ps = form_ps,
  form_glm = form_divname,
...
strata_original_results_3 <- bind_rows(
  strata_states_original_dates_3,
  strata_states_original_cases_3,
  strata_states_original_nonyc_3,
  strata_divname_original_dates_3,
  strata_divname_original_cases_3,
  strata_divname_original_nonyc_3
)

strata_original_results_splitted_3 <- strata_original_results_3 %>%
